<%-- 
    Document   : friendList
    Created on : Dec 22, 2023, 10:25:54 AM
        ...
        <main>
            ...
            <c:choose>
                <c:when test="${not empty friendList}">
                    ...
                    <c:forEach var="foundUser" items="${friendList}">
                        <div class="user">
                            <img src="${foundUser.avatar}" width="70" height="80" alt="Avatar">
                            <a href="profile?id=${foundUser.userId}">
                                <c:out value="${foundUser.firstName} ${foundUser.lastName}"/>
                            </a>
