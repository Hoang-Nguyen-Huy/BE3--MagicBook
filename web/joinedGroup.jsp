<%-- 
    Document   : joinedGroup
    Created on : Dec 29, 2023, 2:17:07 PM
...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <c:choose>
                <c:when test="${not empty joinGroupList}">
                    <h2>Group that ${userName} joined</h2>
                    <c:forEach var="groupList" items="${joinGroupList}">
                        <div class="user">
