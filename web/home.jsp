            ...
            <div id="postsContainer">
                ...
                <c:forEach var="entry" items="${post}">
                    <c:choose>
                        ...
                        <c:when test="${userId eq entry.key.getUserId() or entry.value.getVisibility() eq 'friend' and FriendshipDAO.getInstance().isFriend(userId, entry.key.getUserId()) != null}">
                            <div class="post">
                                <div class="post-avatar">
                                    <div class="avatar-wrapper">
                                        <img src="${entry.key.getAvatar()}" width="35" height="40" alt="Avatar">
